...
function btnClicked() {
  ...
  if (name === "po" || name === "dragon warrior" || name === "kung fu panda") {
    ...
    document.getElementById("chare-img").src = "img/kai.png";
  } else if (name === "mr ping" || name === "mr-ping" || name === "ping") {
    charNameEl.innerHTML = "Mr.Ping";
    charQuoteEl.innerHTML =
      "To make something special, you just have to believe it's special.";
    document.getElementById("chare-img").src = "img/mr-ping.png";
    ...
    document.getElementById("chare-img").src = "img/soothsayer.png";
  } else if (name === "storming ox" || name === "ox") {
    charNameEl.innerHTML = "Storming Ox";
    charQuoteEl.innerHTML = "You insolent fool!";
    document.getElementById("chare-img").src = "img/storimg-ox.png";
    ...
    document.getElementById("chare-img").src = "img/tai-lung.png";
  } else {
